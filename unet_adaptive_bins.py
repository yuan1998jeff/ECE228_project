...
class UnetAdaptiveBins(nn.Module):
    def __init__(self, backend, n_bins=100, min_val=0.1, max_val=10, norm='linear', **kwargs):
        ...
        self.decoder = DecoderBN(num_classes=128, drop_out = kwargs["drop_out"], batch_norm = kwargs["batch_norm"])
